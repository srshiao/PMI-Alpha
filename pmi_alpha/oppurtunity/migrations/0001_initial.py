...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('common', '0001_initial'),
        ('accounts', '0002_auto_20180301_1620'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ManyToManyField(related_name='opportunity_assigned_to', to='common.CRMUser')),
                ('closed_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='common.CRMUser')),
                ('contacts', models.ManyToManyField(to='contacts.Contact')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='opportunity_created_by', to='common.CRMUser')),
