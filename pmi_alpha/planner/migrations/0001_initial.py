...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('common', '0002_auto_20180301_1620'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ManyToManyField(blank=True, related_name='event_assigned_users', to='common.CRMUser')),
                ...
                ('attendees_user', models.ManyToManyField(blank=True, related_name='attendees_user', to='common.CRMUser')),
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_created_by', to='common.CRMUser')),
            ],
        ),
        migrations.CreateModel(
            name='Reminder',
