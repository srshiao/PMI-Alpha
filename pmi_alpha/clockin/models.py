...
class Work(models.Model):
	...
	time_in = models.TimeField(_("Time In"),default = datetime.datetime.now().time(), blank=True,null=True)
	time_out = models.TimeField(_("Time Out"),default = datetime.datetime.now().time(),blank=True,null =True)
